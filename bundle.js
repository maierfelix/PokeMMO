...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Renderer = __webpack_require__(125);
	...
	var _Connection = __webpack_require__(142);
	...
	var _entities = __webpack_require__(153);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _functions2 = __webpack_require__(103);

	var entity = _interopRequireWildcard(_functions2);

	var _Audio = __webpack_require__(90);
	...
	var _MiniMap = __webpack_require__(109);
	...
	var _Environment = __webpack_require__(112);
	...
	var _Language = __webpack_require__(124);
	...
	var Engine = function (_DisplayObject) {
	    ...
	    function Engine(instance, width, height) {
	         ...
	         * @type {Object}
	         */
	        _this.controller = new _Controller2.default(_this);
	    ...
	    (0, _createClass3.default)(Engine, [{
	        ...
	        value: function updateSound() {
	            ...
	            if (map === null || map.entityNoises.length <= 0) return void 0;

	            var entity = null;

	            var ii = 0;
	            var length = map.entityNoises.length;
	        ...
	        key: "updateEntityNoise",
	        value: function updateEntityNoise(entity, dist) {
	            ...
	            if (_Math2.default.pointIntersectsCircle(dx, dy, cx, cy, radius) === true) {
	                if (entity.noise.isInView === false) {
	                    ...
	                    entity.noise.fadeIn(_cfg.VOLUME.ENTITY_NOISE / 1e2, _cfg.VOLUME.FADE_SPEED, function () {
	                        return entity.noise.fadingIn = false;
	                    });
	                ...
	                if (entity.noise.isInView === true) {
	                    if (entity.noise.fadingIn === true) {
	                        entity.noise.volume(_cfg.VOLUME.ENTITY_NOISE / 1e2);
	                    }
	                    entity.noise.fadingOut = true;
	                    entity.noise.fadeOut(.0, _cfg.VOLUME.FADE_SPEED, function () {
	                        return entity.noise.fadingOut = false;
	                    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function cloneEntity(entity) {
	  ...
	  if (entity instanceof _MapEntity2.default) {
	    clone = new _MapEntity2.default(tmp);
	  } else {
	    clone = tmp;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _render = __webpack_require__(106);
	...
	var _Commander = __webpack_require__(107);

	var _Commander2 = _interopRequireDefault(_Commander);

	var _commands = __webpack_require__(108);
	...
	var Controller = function () {
	    ...
	    (0, _createClass3.default)(Controller, [{
	        ...
	        value: function action(name) {
	            ...
	            var args = arguments.length <= 1 || arguments[1] === undefined ? args || [] : arguments[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tokens = __webpack_require__(113);

	var tokens = _interopRequireWildcard(_tokens);

	var _Tester = __webpack_require__(114);

	var _Tester2 = _interopRequireDefault(_Tester);

	var _Tokenizer = __webpack_require__(117);
	...
	var _Evaluator = __webpack_require__(122);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NodeList = __webpack_require__(115);

	var _tests = __webpack_require__(116);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _precedence = __webpack_require__(119);
	...
	var _expression = __webpack_require__(121);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _functions = __webpack_require__(103);

	var entity = _interopRequireWildcard(_functions);

	var _render = __webpack_require__(131);
	...
	var _webgl = __webpack_require__(137);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Howler = __webpack_require__(127);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function renderEntity(entity, x, y, width, height, eWidth, eHeight) {
	  ...
	  if (entity.type === _cfg.TYPES.Notification) {
	    var padding = (Math.max(entity.follow.size.x, entity.size.x / 2) / 2 - entity.follow.size.x / 2 - entity.follow.xMargin - (entity.size.x === entity.follow.size.x ? _cfg.DIMENSION : 0)) * resolution;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shaders = __webpack_require__(138);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Keyboard = __webpack_require__(140);

	var _Keyboard2 = _interopRequireDefault(_Keyboard);

	var _Mouse = __webpack_require__(141);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _toConsumableArray2 = __webpack_require__(143);
	...
	var _Packets = __webpack_require__(147);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Facing = __webpack_require__(148);
	...
	var _Jumping = __webpack_require__(149);
	...
	var _Velocity = __webpack_require__(151);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Player = __webpack_require__(154);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _movement = __webpack_require__(155);
